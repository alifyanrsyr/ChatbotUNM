...
def load_response():
   global responses
   responses = {}
   with open('website/dataset/data.json') as content:
...
def preparation():
   ...
   tokenizer = pickle.load(open('website/model/tokenizer.pkl', 'rb'))
   le = pickle.load(open('website/model/words.pkl', 'rb'))
   model = keras.models.load_model('website/model/chat_model.h5')
